...
//gérer l'animation des boutons sons lorsque le timer est en pause


// ---------------------- VARIABLES-----------------------------------
// ----------------------------------------------------------------------
var timerId = null;//pour le timer...
var timerId_2 = null;//pour le timer des boutons sons
...
var metronome_sound = soundFiles[5]; //le son du metronome
...
var rec = false; //pour vérifier si l'enregistrement est enclenché
...
function startTimer2() {
        ...
        timerId_2 = window.setInterval("timer_sequencer2()", 10);
        console.log("hop");
}
...
// fonction pour avoir un timer indépendant pour la gestion affichage des boutoons
function timer_sequencer2 () {

  // console.log("timer seq 2 on");
...
//        playSound(key_sounds["W"]);
    zone_triangle.style.backgroundColor = "white";
    }
